...
Ads.MultiDropdownMenu = function(items, options) {
  ...
  function onItemClick(e) {
    if (e.target.className == 'ads_dd_menu_item_checkbox_on') {
  ...
  for (var i in items) {
    ...
    curItems[i].c = 'ads_dd_menu_item_checkbox_off';
...
Ads.checkBudgetSumInc = function(isRequest) {
  ...
  if (window.curIsMoney) {
    if (window.curLegal) {
      if (floatBudgetInc < cur.unionsLimits.budget_increase_rubles_min) {
...
Ads.showRetargetingGroupBox = function(unionId, groupId) {
  ...
  showBox('/ads?act=a_retargeting_group_box', ajaxParams, showOptions);

  return false;
}
Ads.showRetargetingGroupPixel = function(unionId, groupId, hash) {
  groupId = intval(groupId);
  ...
  showBox('/ads?act=a_get_retargeting_pixel', ajaxParams, showOptions);

  return false;
}
Ads.deleteRetargetingGroup = function(unionId, groupId, hash) {
  groupId = intval(groupId);
  ...
  showFastBox(getLang('ads_retargeting_del_confirm_title'), getLang('ads_retargeting_del_confirm_message'), getLang('box_yes'), function() {
    ajax.post('/ads', {act: 'a_del_retargeting_group', union_id: unionId, group_id: groupId, hash: hash}, {
