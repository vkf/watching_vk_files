...
addDocBox: function() {
  showBox('docs.php', {act: 'add_box', oid: cur.oid}, {params: {width: '410px', bodyStyle: 'padding: 0px; position: relative;'}});
},
...
editItem: function(oid, did) {
  showBox('docs.php', {act: 'edit_box', oid: oid, did: did});
},
...
getLink: function(oid, docId) {
  showBox('docs.php', {act: 'get_doc_link_box', oid: oid, did: docId});
},
...
openItem: function (oid, did, hash) {
  showBox('docs.php', {act: 'open_box', oid: oid, did: did, hash: hash});
},
