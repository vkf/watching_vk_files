window.events = {
  showInviteBox: function(e, gid) {
    showBox('al_page.php', {act: 'a_invite_box', gid: gid}, {params: {bodyStyle: "padding: 0px;", width:460}});
    return false;
  },
  showCommonBox: function(e, gid, hash) {
    showBox('al_page.php', {act: 'a_friends_in_group', gid: gid, hash: hash}, {params: {bodyStyle: "padding: 0px;"}});
    return false;
  },
  createEvent: function(hash) {
    var b = showBox('al_page.php', {act:'a_edit_event_box'}); /*.setButtons(getLang('global_save'), function() {
  ...
  showMapBox:function(placeID, zoom, link) {
    ...
    showTabbedBox('places.php', {act: 'a_get_place_box', id: placeID}, {stat: ['places.css', 'map.css', 'maps.js', 'ui_controls.css', 'ui_controls.js']});
  },
