var sorter = {
  ...
  mousedown: function(ev) {
    ...
    var el = this, s = el.parentNode.sorter, evc = sorter.evCoords(ev);
    ...
    extend(sorter, {lastX: evc[0], lastY: evc[1], lastS: scrollNode.scrollTop});
  ...
  mousemove: function(ev) {
    ...
    var cancel = true, evc = (ev.type == 'scroll') ? [sorter.lastX, sorter.lastY + scrollNode.scrollTop - sorter.lastS] : sorter.evCoords(ev);
